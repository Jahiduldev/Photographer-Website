...
<html>
    ...
    <section id="container" >
        ...
        <header class="header white-bg">
            ...
            <!--logo start-->
            <a href="<?php echo site_url('dashboard');  ?>" class="logo">Towfiq's Gallery</span></a>
            <!--logo end-->
        ...
        <section id="main-content">
            <section class="wrapper site-min-height">
                <div class="row">
                    <div class="col-lg-12">
                        <form class="cmxform form-horizontal tasi-form" id="addUserForm"   role="form" method="post"  action="<?php echo site_url('create_folder/uploadData');?>" enctype="multipart/form-data">
                            <div class="form-group">
                                <label for="inputSuccess" class="col-sm-2 control-label col-lg-2">Category</label>
                                <div class="col-lg-10">
                                    <select class="form-control" name="select_cat" id="select_cat"> <!-- input-sm m-bot15  -->
                            ...
                            <div class="form-group">
                                <label for="inputSuccess" class="col-sm-2 control-label col-lg-2">Folder Name </label>
                                <div class="col-lg-10">
                                    <input type="text" class="form-control" name="sub_folder" id="sub_folder" />
                                </div>
                            </div>
                            <div class="form-group" id="upload_div">
                                <label for="inputSuccess" class="col-sm-2 control-label col-lg-2">Upload Folder Image</label>
                                <div class="col-lg-10">
                                    <input type="file" name="userfile" id="userfile" size="20" />
                                </div>
                            </div>
                            <div class="form-group">
                                <input type="submit"  class="col-lg-offset-2" value="Submit" />
                            </div>
