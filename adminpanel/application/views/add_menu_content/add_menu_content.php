    ...
    <section id="container" >
        ...
        <section id="main-content">
            <section class="wrapper site-min-height">
                <div class="row">
                    <div class="col-lg-12">
                        <form class="cmxform form-horizontal tasi-form" id="addUserForm" onsubmit="return test()"  role="form" method="post"  action="<?php echo site_url('add_menu_content/uploadData');?>" enctype="multipart/form-data">
                            <div class="form-group">
                                <label for="inputSuccess" class="col-sm-2 control-label col-lg-2">Select Menu</label>
                                <div class="col-lg-10">
                                    <select class="form-control" name="menu_id" id="menu_id" required onchange="getMenuContent(this.value)"> <!-- input-sm m-bot15  -->
   ...
   <!--  <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.5/js/bootstrap.min.js"></script>-->
    ...
    <script type="text/javascript">
        ...
        function getMenuContent(menu_id){
            ...
            $.ajax({
                type: "Post",
                url: "<?php echo site_url('add_menu_content/getMenuContent');  ?>",
