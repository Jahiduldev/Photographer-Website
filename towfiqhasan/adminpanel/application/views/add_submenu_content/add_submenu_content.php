...
<html>
    ...
    <section id="container" >
        ...
        <section id="main-content">
            <section class="wrapper site-min-height">
                <div class="row">
                    <div class="col-lg-12">
                        <form class="cmxform form-horizontal tasi-form" id="addUserForm" onsubmit="return test()"  role="form" method="post"  action="<?php echo site_url('add_submenu_content/uploadData');?>" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-10">
                                    <select class="form-control" name="select_sub_menu" id="select_sub_menu" onchange="getSubMenuContent(this.value);"> <!-- input-sm m-bot15  -->
   ...
   <!--  <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.5/js/bootstrap.min.js"></script>-->
    ...
    <script type="text/javascript">
        ...
        function getSubMenuContent(submenu_id){
            var submenu_id=submenu_id;
            $.ajax({
                type: "Post",
                url: "<?php echo site_url('add_submenu_content/getSubMenuContent');  ?>",
